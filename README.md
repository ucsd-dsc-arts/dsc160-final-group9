...
### Music Production
- We combine the lyrics with the accompnayment by singing the lyrics out and playing the accompaniment with a keyboard. We played the output audio from Classical-Piano-Composer slowly in order to sing the lyrics out fluently. We took the first half of the translated lyrics from the lstm model and sang it out. Then, we made a music video: [video with bilingual subtitles](https://github.com/ucsd-dsc-arts/dsc160-final-group9/blob/master/result/final_result/result_with_chinese.mp4)
