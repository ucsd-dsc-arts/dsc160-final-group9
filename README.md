...
This notebook is trained on a set-up keras backend. In case you do not have keras installed, we have provided the command for it as follows:
...
`Pickle` is a module that implements binary protocols for serializing and de-serializing a Python object structure.
